...
using Alsofer.FluxoCaixa.IOC;
using Alsofer.FluxoCaixa.API.Setup;

namespace Alsofer.FluxoCaixa.API
{
    public class Startup
    {
        ...
        public void AddSwaggerExtension(IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = " Alsofer Fluxo de Caixa - WebApi",
                    Description = "API"
                });
